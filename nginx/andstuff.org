server {
  ...
  location / {
    ...
    rewrite ^/FunctionalPython$            http://scottmoonen.com/2005/06/09/functional-python/ permanent;
    ...
    rewrite ^/GoedelEscherBach$            http://scottmoonen.com/2005/03/25/goedel-escher-bach/ permanent;
    ...
    rewrite ^/IntroductionToPointers$      http://scottmoonen.com/2004/10/02/introduction-to-pointers-in-c/ permanent;
    ...
    rewrite ^/PythonPersistence$           http://scottmoonen.com/2004/10/01/python-persistence/ permanent;
    rewrite ^/PythonSpikes$                http://scottmoonen.com/category/python/ permanent;
    ...
    rewrite ^/ResumeAdvice$                http://scottmoonen.com/2006/06/09/resume-keywords/ permanent;
